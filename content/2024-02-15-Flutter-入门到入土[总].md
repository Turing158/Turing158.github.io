...
1. 前往[Java Downloads - Oracle](https://www.oracle.com/java/technologies/downloads/)下载所需要的**jdk**，**JDK17**版本够用了
   ...
   ![image-20240221220731441](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946825978_image-20240221220731441.webp)

2. 配置系统环境

   1. 新建**系统变量**，第一行输入`JAVA_HOME`，第二行输入安装**jdk**的目录

   ![image-20240221220920299](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946812322_image-20240221220920299.webp)

   2. 在系统变量中找到**Path**双击点开，点击**新建**，并输入`%JAVA_HOME%\bin`

      ![image-20240221221122941](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946819329_image-20240221221122941.webp)

   3. 一直点确定，然后再**cmd**中输入`java -version`，一般来说出现的就是**版本号**，若不行，重启下电脑，若还不行，重新安装吧！

      ![image-20240221221239951](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946818093_image-20240221221239951.webp)
...
2. 安装完毕之后，点击**左边的第三项**，插件，我这里汉化了，[汉化教程](https://blog.csdn.net/weixin_46396315/article/details/136222867)
   ...
   ![image-20240221222652529](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946810753_image-20240221222652529.webp)

3. **搜索并安装**这两个插件，然后重启**Android Studio**

   ![image-20240221222754434](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946815739_image-20240221222754434.webp)
...
1. 前往**Flutter**官网下载**FlutterSDK**，[Flutter SDK archive - Flutter](https://docs.flutter.dev/release/archive?tab=windows#windows)
   ...
   ![image-20240221221501653](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946820806_image-20240221221501653.webp)

2. 将下载好的压缩包**解压**，然后**配置环境**，双击系统变量的**Path**，新建并输入刚刚解压到的**文件夹到bin目录的路径**

   ![image-20240221222100461](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946822558_image-20240221222100461.webp)

3. 在**cmd**中输入`flutter doctor`,等待一下，出现这些

   ![image-20240221222239684](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946835381_image-20240221222239684.webp)
...
4. 常见问题
   ...
   ![image-20240221224246524](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946821434_image-20240221224246524.webp)
   ...
   根据以下步骤：
    ...
    1. 打开**Android Studio**，关闭项目，到开始页面，点最右边的竖着的三个点，选择**SDK Manager**
       ...
       ![image-20240227133113310](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946828314_image-20240227133113310.webp)

    2. 点第二项**SDK Tools**，在下面找到**Android SDK Command-line Tools**并勾选，点击确定

       ![image-20240227133341573](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946835495_image-20240227133341573.webp)

    3. 点击**确定***[我这里因为已经最新了，所以下载的东西与你们出问题的不一样]*

       ![image-20240227133545643](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946829171_image-20240227133545643.webp)

    4. 等待这个界面下载，下载完成就点**完成**

       ![image-20240227133616137](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946840460_image-20240227133616137.webp)
...
1. 一切准备好之后，会看到**Android Studio**右上角有个`New Flutter Projec`t的按钮，点这个按钮是为了创建**Flutter**项目
   ...
   ![image-20240221224925325](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946822992_image-20240221224925325.webp)
...
3. 这里就是项目的基本信息
   ...
   ![image-20240221225231548](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946827912_image-20240221225231548.webp)
   ...
   ![image-20240221223029914](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946817061_image-20240221223029914.webp)
...
- 参数比较多，都是比较基本的图片颜色混合
  ...
  ![image-20240208211305060](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946818868_image-20240208211305060.webp)
...
1. 在目录新建储存图片的文件夹
   ...
   ![image-20240208211756026](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946812621_image-20240208211756026.webp)
...
![image-20240215001347386](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946812556_image-20240215001347386.webp)
...
![image-20240216010733781](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946813044_image-20240216010733781.webp)
...
![image-20240218015044614](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946811694_image-20240218015044614.webp)
...
![image-20240218015710797](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946822872_image-20240218015710797.webp)
...
![image-20240218020510178](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946815339_image-20240218020510178.webp)
...
![image-20240218020618137](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946815605_image-20240218020618137.webp)
...
![image-20240218231334250](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946812117_image-20240218231334250.webp)
...
![image-20240218231425408](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946808359_image-20240218231425408.webp)
...
![image-20240223160855740](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946820950_image-20240223160855740.webp)
...
![image-20240223160921240](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946820842_image-20240223160921240.webp)
...
![image-20240223161246468](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946822336_image-20240223161246468.webp)
...
![image-20240228002642882](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946842770_image-20240228002642882.webp)
...
![image-20240228002720931](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946829759_image-20240228002720931.webp)
...
![image-20240228002755697](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946825104_image-20240228002755697.webp)
...
![image-20240228002910958](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946830863_image-20240228002910958.webp)
...
![image-20240228003019407](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946833344_image-20240228003019407.webp)
...
![image-20240228003116469](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946825236_image-20240228003116469.webp)
...
![image-20240302195145912](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946833868_image-20240302195145912.webp)
...
2. 使用`showDialog()`，以及将方法变为异步方法，这里来看一下showDialog的属性
...
6. 效果
   ...
   ![image-20240303005012077](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946836095_image-20240303005012077.webp)
...
![image-20240303005251254](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946830507_image-20240303005251254.webp)
...
![image-20240303005520021](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946836613_image-20240303005520021.webp)
...
![image-20240302204856669](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946828735_image-20240302204856669.webp)
...
![image-20240302204959441](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946832408_image-20240302204959441.webp)
...
2. 在返回页面的方法里，通过`ModalRoute.of(context)?.settings.arguments`获取传入的数据，如果只传一个参数，那就直接将变量转成String类型即可，但是如果是其他的形式，例如：我传的是一个List，我需要将变量转成字符串，然后再将它转换成List才能拿出来使用
...
![image-20240302212751760](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946828007_image-20240302212751760.webp)
...
![image-20240302213141227](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946828355_image-20240302213141227.webp)
...
![image-20240302220954064](https://pic.turing158.de5.net/file/Flutter-Tutorial/1787946836044_image-20240302220954064.webp)
